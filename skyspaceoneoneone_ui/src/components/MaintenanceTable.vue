...
<template>
  ...
  <base-input label="DateScheduled" type="text" placeholder="Enter DateScheduled" v-model="maintenanceToAdd.dateScheduled"></base-input>
                  </form>
                </div>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'dateScheduled',
          visible: true,
          scopedSlots: { customRender: 'dateScheduled' },
          sorter: true
          //sorter: (a, b) => a.dateScheduled - b.dateScheduled,
          //sorter: (a, b) => a.dateScheduled.localeCompare(b.dateScheduled),
        },
      ],
      pagination: {
        current: 1,
